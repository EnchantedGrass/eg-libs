...
class EgMessageKtTest {
    @MockK
    lateinit var audience: Audience

    @Test
    fun `sendMessage should send a text message`() {
    ...
    @Test
    fun `sendActionBar should send an action bar message`() {
    ...
    @Test
    fun `sendMessage should send a title message`() {
    ...
    @Test
    fun `sendMessage should play a sound`() {
    ...
    @Test
    fun `sendMessage should send a composite message`() {
        justRun { audience.sendMessage(any<Component>()) }
        justRun { audience.sendActionBar(any()) }
        justRun { audience.showTitle(any()) }
        justRun { audience.playSound(any()) }
